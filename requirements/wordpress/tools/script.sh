...
# #line 23
# sed -i -r "s/database/walid/1"   wp-config.php
# #line 26
...
wp core install --url=werrahma.42.fr/ --title=hello --admin_user=$WP_ADMIN_USR --admin_password=$WP_ADMIN_PWD --admin_email=$WP_ADMIN_EMAIL --skip-email --allow-root
